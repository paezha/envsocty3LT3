...
1. Find the shortest-path distance from the plants to the stores and obtain a cost matrix (use a rate of $14/km) (10)

2. Calculate the cost of of transportation according to the current delivery schedule (20)
...
6. Neigbhors have complained about trucks in residential neighborhoods, how would things change is all local streets were closed to trucks. 

NEW VERSION?

Make it instad of an individual exercise something that students can do in pairs and compete.
