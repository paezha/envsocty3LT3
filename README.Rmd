...
_Readings_ are designed to be like mini-chapters in a book. What makes them different from a conventional book is that they are interactive and editable, which means that you can work with them in ways not possible with a conventional printed book.

These include:

```{r echo=FALSE, eval=FALSE}
file.edit("inst/rmarkdown/templates/exercise-1/skeleton/skeleton.Rmd")
file.edit("inst/rmarkdown/templates/exercise-2/skeleton/skeleton.Rmd")
file.edit("inst/rmarkdown/templates/exercise-3/skeleton/skeleton.Rmd")
file.edit("inst/rmarkdown/templates/exercise-4/skeleton/skeleton.Rmd")
file.edit("inst/rmarkdown/templates/exercise-5/skeleton/skeleton.Rmd")
file.edit("inst/rmarkdown/templates/exercise-6/skeleton/skeleton.Rmd")
```
...
_Exercises_ are the documents that you will use to complete most of your coursework. The templates are pre-formatted for you, so you do not have to think about how to prepare the document, and can instead devote your attention and energy to learn while creating great content.
...
```
__Figure 14.__ _Knitting the exercise_
