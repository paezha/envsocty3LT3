...
```{r echo=FALSE, fig.cap="Figure 14. Writing the highlights of the exercise"}
knitr::include_graphics("images/14-Working-on-an-Exercise-Highlights.gif")
```

The highlights and threshold concepts are the last element of your exercise, and after writing them you can knit the document to generate the pdf file for submission (see Figure 15).
```{r echo=FALSE, fig.cap="Figure 14. Writing the highlights of the exercise"}
knitr::include_graphics("images/15-Knitting-the-Exercise.gif")
```
